...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2021 at 04:58 PM
...
CREATE TABLE `apartments` (
  ...
  `total_rooms` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `apartments` (`a_id`, `owner fullname`, `owner mobile`, `owner email`, `state`, `city`, `landmark`, `rent`, `deposit`, `plot_number`, `apartment_name`, `ap_number_of_flat`, `total_rooms`, `floor`, `address`, `accommodation`, `description`, `image`, `vacant`, `created_at`, `updated_at`, `broker_id`) VALUES
...
INSERT INTO `appt` (`appt_id`, `user_id`, `broker_id`, `Date`, `Time`) VALUES
(0, 2, 6, '2020-07-15', '2020-08-05 14:17:09'),
(1, 8, 3, '2020-02-04', '2020-03-10 14:14:43'),
(2, 2, 7, '2020-03-10', '2020-05-14 14:16:08');
...
INSERT INTO `broker` (`broker_id`, `bstate`, `bcity`, `barea`, `address`, `fullname`, `gender`, `username`, `email`, `mobile`, `pan_card_no`, `password`, `registration_no`, `profile_img`, `role`, `status`) VALUES
(3, 'Gujarat', 'Ahmedabad', 'Navrangpura', 'Jai Hind Nagar Street no. 6 New Colony', 'Nishant Jain', 'Male', 'nishant27', 'nj27nishant@gmail.com', '9521681348', 'BRKPJ9087L', 'nishant27', 'AD2929292929', 'uploads\\profile\\broker6.jpg', 'broker', 'Active'),
(6, 'Rajasthan', 'Udaipur', 'Bapu Bazaar', 'DelhiGate', 'Jay Mehta', 'Male', 'Jay', 'Jay.mehta@gmaill.com', '9458796523', 'BROSK2321J', 'Jay@123', 'QW2384726347', 'uploads\\profile\\broker9.jpg', 'broker', 'Active'),
(7, 'Gujarat', 'Ahmedabad', 'Maninagar', 'Nehru Nagar', 'Nayshree Pachori', 'Female', 'Nayshree', 'nayshreepachori@gmail.com', '9954342345', 'BWRSH2347H', 'Nayshree@123', 'DS2345675432', 'uploads\\profile\\broker10.jpg', 'broker', 'Active');
...
--
-- Table structure for table `tenaments`
--

CREATE TABLE `tenaments` (
  ...
  `deposit` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `plot_number` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `total_rooms` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `accommodation` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `tenaments`
--

INSERT INTO `tenaments` (`t_id`, `owner fullname`, `owner mobile`, `owner email`, `state`, `city`, `landmark`, `rent`, `deposit`, `plot_number`, `total_rooms`, `address`, `accommodation`, `description`, `image`, `vacant`, `created_at`, `updated_at`, `broker_id`) VALUES
...
INSERT INTO `users` (`user_id`, `state`, `city`, `address`, `u_fullname`, `gender`, `u_mobile`, `username`, `u_email`, `password`, `profile_img`, `role`, `status`) VALUES
...
--
-- Indexes for table `tenaments`
--
ALTER TABLE `tenaments`
...
--
ALTER TABLE `appt`
  ADD CONSTRAINT `appt_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `appt_ibfk_2` FOREIGN KEY (`broker_id`) REFERENCES `broker` (`broker_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
